...
#gold tickers
stonks = ['VRTX', 'CHGG', 'SHOP', 'TSLA', 'DOCU', 'CLDR', 'TTD', 'SPCE']

# fetch the stock data
dr = tiingo.TiingoDailyReader(symbols=stonks, start=dMarketBottom, end=dStrToday, api_key=tKey)
df = dr.read()
dr.close()
...
df_close = df.loc[stonks,['adjClose']]
...
perf_ytd.plot(title='Stonks YTD Performance', figsize=(20,10))